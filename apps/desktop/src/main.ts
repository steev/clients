...
export class Main {
  ...
  constructor() {
    ...
    this.stateService = new ElectronStateService(
      ...
      new AccountServiceImplementation(null, this.logService, this.globalStateProvider), // will not broadcast logouts. This is a hack until we can remove messaging dependency
